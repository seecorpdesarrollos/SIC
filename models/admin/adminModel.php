<?php 
 ...
 class AdminModel{
    ...
    static public function getAdminModelUsuario($tabla,$id){
    ...
    $sql->close();
 	...
 	static public function fecha($tabla,$id){
 	...
 	static public function cambiarPassworModel($datosModel,$tabla){
   ...
   //  }
    ...
    static public function agregarUsuariosModel($datosModel,$tabla){
   ...
   static public function deleteUsuarioModel($datosModel,$tabla){
